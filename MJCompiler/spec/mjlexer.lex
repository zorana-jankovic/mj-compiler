...
"+=" 		{ return new_symbol(sym.ADDRIGHT, yytext()); }
"-=" 		{ return new_symbol(sym.SUBRIGHT, yytext()); }
"*=" 		{ return new_symbol(sym.MULRIGHT, yytext()); }
"/=" 		{ return new_symbol(sym.DIVRIGHT, yytext()); }
"%=" 		{ return new_symbol(sym.MODRIGHT, yytext()); }
...
"<=" 		{ return new_symbol(sym.SMALLEROREQUAL, yytext()); }
